...
<style type="text/css">
	.legal a, .legal a:link, .legal a:active {
		color: #999 !important;					
	}
	.legal a:hover {
		color: #666 !important;
...
<section id="content" class="content-block inverse">
    ...
    <div class="row legal">
      <div class="large-12 medium-12 columns">
        <h1>Aviso Legal</h1>
				...
				<p>El titular del sitio web es la sociedad Casio España, S.L. (en adelante, "Casio"), con domicilio social en la calle Josep Plà, 2 – Torre B-2 – 12 - 08019 Barcelona y correo electrónico info@casio-ecr.es. Casio es una sociedad inscrita en el Registro Mercantil de Barcelona, Tomo 33.673, folio 1, hoja B-233.746, con CIF número B-62600234.</p>
				...
				<p>El acceso a este web implica el uso de cookies. Ver en este sentido la <a href="./politica-de-cookies.php">Política de cookies</a>.</p>
				...
				<p>Ver la <a href="./proteccion-de-datos.php">Política de protección de datos</a>.</p>
				...
				<p><small>Versión de fecha: 20 de Marzo de 2018</small></p>
